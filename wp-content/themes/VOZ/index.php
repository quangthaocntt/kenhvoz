...
<script>
    $(document).on('ready', function(){
        ...
        $(window).scroll(function() {
            //load data
//            if(loadingItemPost == 0 && $(window).scrollTop() + $(window).height() > $(document).height() - 100) {
//                console.log("Load more data");
//                jVozDesign.loadItemPost();
//            }
                ...
                <div class="content-item-post">
                    ...
                    <article class="main_inner clearfix"  >
                        ...
                        <div class="voz-post-info ng-scope">
                            ...
                            <span
                                class="post-meta ng-scope">Đăng bởi <a target="_blank" href="/u/88022" class="ng-binding"><?php the_author(); ?></a>  |  Thời gian <span class="timer ng-binding">
                                    <?php 
