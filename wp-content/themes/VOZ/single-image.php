...
<div class="row content-post ">
    <div class="col-md-8 font-special">
        ...
        <div style="border-bottom: 1px solid #ddd;">
            ...
            <img style="margin-top: 10px;" class="img-responsive " alt="<?php the_title(); ?>" title="<?php the_title(); ?>" src="<?php echo $feat_image; ?>" >
                ...
                <div id=" row">
                    ...
                    <div class="unreadPostsContainer col-md-4">
                        <a href="<?php the_permalink(); ?>">
                            <img class="img-responsive imgCommemtBox " title="<?php the_title(); ?>" src="<?php echo wp_get_attachment_url( get_post_thumbnail_id($post->ID) ) ?>" />
                    ...
                    <div class="unreadPostsContainer col-md-4">
                        <a href="<?php the_permalink(); ?> ">
                            ...
                            <?php 
                                ...
                                $feat_image = wp_get_attachment_url( get_post_thumbnail_id($post->ID) );
                            ?>
                            <img class="img-responsive imgCommemtBox " src="<?php echo wp_get_attachment_url( get_post_thumbnail_id($post->ID) ) ?>" />
                            <?php elseif ($format == "link") : ?>
                            <?php 
                                list($videoType, $videoId) = split(':', $post->post_content);
                                if($videoType == "youtube"): 
                            ?>
                            <img class="img-responsive  imgCommemtBox" alt="<?php the_title(); ?>" src="http://img.youtube.com/vi/<?php echo $videoId;  ?>/0.jpg" >
