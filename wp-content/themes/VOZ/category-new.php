        ...
        <div class="row content-post">
            <div class="col-md-8">
                ...
                $args = array(
                            ...
                            'meta_key'         => '',
                            'meta_value'       => '',
                            'post_type'        => array('post','video','image','story'),
                            'post_mime_type'   => '',
                            'post_parent'      => '',
                            'author'	   => '',
                            'post_status'      => 'publish',
                ...
                <article class="main_inner clearfix"  >
                    ...
                    <div class="voz-post-info ng-scope">
                        ...
                        <span
                            class="post-meta ng-scope">Đăng bởi <a target="_blank" href="/u/88022" class="ng-binding"><?php echo the_author(); ?></a> <span class="timer ng-binding">15 phút trước</span>
                        </span>
